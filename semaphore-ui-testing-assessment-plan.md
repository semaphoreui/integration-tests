...
**Текущий статус:** тестовые профили обновлены до `v2.19.8`, upstream `develop` — до `ae12f3acac626f78673b95cc57acd62ed873b089`. Полный Linux CI от 2026-08-19 зелёный: core suite прошла на SQLite, PostgreSQL, MySQL 8.4 и MariaDB 10.11, remote runner зарегистрирован и выполняет task-сценарии, оба upgrade-профиля `v2.19.7 → v2.19.8` прошли. Локально на macOS остаётся воспроизводимый риск нестабильной финализации task output; он не подтверждён последним Linux CI и описан в `test-environment/v2.19.8-regression-report.md`.
