...
**Текущий статус:** тестовые профили обновлены до `v2.19.8`, upstream `develop` — до `ae12f3acac626f78673b95cc57acd62ed873b089`. Core suite прошла на PostgreSQL, MySQL 8.4 и MariaDB 10.11; remote runner зарегистрирован и выполняет task-сценарии. SQLite, runner и upgrade-профили выявили нестабильную финализацию task output в `v2.19.8`; диагностика находится в `test-environment/v2.19.8-regression-report.md`.
