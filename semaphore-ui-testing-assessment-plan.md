...
Для анализа не обязательно разбирать все issues одинаково глубоко. Сначала делаем общий срез, затем подробно изучаем репрезентативную выборку из наиболее важных кластеров.
