...
public class StepsParameterResolver implements ParameterResolver {
  ...
  private static final Set<Class<?>> FRAMEWORK_TYPES =
      Set.of(TestStore.class, TeardownStorage.class, TestUser.class);
  ...
  public boolean supportsParameter(
    ...
    return FRAMEWORK_TYPES.contains(type)
        || STEP_TYPES.contains(type)
        || FixtureCatalog.supports(type);
  }
  ...
  public Object resolveParameter(
    ...
    if (FixtureCatalog.supports(type)) {
      return FixtureCatalog.resolve(type, extensionContext);
    }
