...
public class SemaphoreUserSteps {

  private final SemaphoreUsersApi api;
  private final TeardownStorage teardown;

  @Inject
  public SemaphoreUserSteps(SemaphoreUsersApi api, TeardownStorage teardown) {
    this.api = api;
  ...
  public void verifyGuestCannotCreateAccessKey(SemaphoreSessionApis session, long projectId) {
    Calls.expectStatus(
        session
            .accessKeys()
            .createAccessKey(
