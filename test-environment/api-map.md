...
10. Core project resource maintenance: read/update access keys, repositories, inventories, and templates; execute the updated chain, list recent tasks, and stop every active task for a template.
